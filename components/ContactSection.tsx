...
export default function ContactSection() {
  const button = tw`transition-all select-none border-1 border-current text-g60 font-semibold leading-none tracking-tight py-3 px-4.5 rounded hover:text-secondary`;
