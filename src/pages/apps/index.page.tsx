      ...
      <div className={style.Main}>
        <div className={style.section}>
          ...
          <div className={style.content}>
            <Card>{{ name: 'Music Player v2', link: '/apps/retro-music', image: '/imgs/apps/retro-music-2.webp' }}</Card>
            <Card>{{ name: 'Music Player', link: '/apps/retro-music-1', image: '/imgs/apps/retro-music.webp' }}</Card>
